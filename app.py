...
from eksamensopgave_2.elements.rendering import title, subheading, option_header, option_1, option_2, option_3, terminal_size
...
# App rendering
## render main menu
ren.render_main(title, subheading, option_header, option_1, option_2, option_3)
